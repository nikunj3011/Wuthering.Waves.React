...
const WeaponsCard = ({ data }) => {
    ...
    // var { icon, name, description, rarity, type, baseAtk, bonusStat, rarityDes } = data;
    var icon = "https://static.dotgg.gg/wuthering-waves/" + data.icon
    var rarityClass = "Star" + data.rarity
    return (
        <div className="col-lg-4 col-6 text-left" style={{padding:10}}>
            ...
            <div className="icon_box row">
                <div className="col-lg-5 ">
                    <img src={icon} alt="Icon Box" className={rarityClass}/>
                </div>
                <div className="col-lg-7 ">
                    <h4 className="text-white">{data.name}</h4>
                    <p className="text-gray"><b>Rarity: </b>{data.rarity}  &nbsp; {data.type}</p>
                </div>
            </div>
            ...
            <div className="row" style={{backgroundColor:"#1B1917"}}>
                <div className="col-lg-6" style={{paddingTop:10}}>
                    <p className="text-gray-600"><b>ATK (Lv.1): {data.atk} </b></p>
                </div>
                {/* <div className="col-lg-6" style={{paddingTop:10}}>
